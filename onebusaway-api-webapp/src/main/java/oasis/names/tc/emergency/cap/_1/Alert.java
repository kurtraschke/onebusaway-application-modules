...
public class Alert {
    ...
    @XmlElement(required = true)
    protected Alert.StatusType status;
    @XmlElement(required = true)
    protected Alert.MsgTypeType msgType;
    protected String source;
    @XmlElement(required = true)
    protected Alert.ScopeType scope;
     ...
     * @return
     *     possible object is
     *     {@link Alert.StatusType }
     *     
     */
    public Alert.StatusType getStatus() {
        return status;
    }
     ...
     *     
     */
    public void setStatus(Alert.StatusType value) {
        this.status = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link Alert.MsgTypeType }
     *     
     */
    public Alert.MsgTypeType getMsgType() {
        return msgType;
    }
     ...
     *     
     */
    public void setMsgType(Alert.MsgTypeType value) {
        this.msgType = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link Alert.ScopeType }
     *     
     */
    public Alert.ScopeType getScope() {
        return scope;
    }
     ...
     *     
     */
    public void setScope(Alert.ScopeType value) {
        this.scope = value;
    }
    ...
    public static class Info {
        ...
        @XmlElement(required = true)
        protected List<Alert.Info.CategoryType> category;
        @XmlElement(required = true)
        protected String event;
        protected List<Alert.Info.ResponseTypeType> responseType;
        @XmlElement(required = true)
        protected Alert.Info.UrgencyType urgency;
        @XmlElement(required = true)
        protected Alert.Info.SeverityType severity;
        @XmlElement(required = true)
        protected Alert.Info.CertaintyType certainty;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Alert.Info.CategoryType }
         * 
         * 
         */
        public List<Alert.Info.CategoryType> getCategory() {
            if (category == null) {
                category = new ArrayList<Alert.Info.CategoryType>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Alert.Info.ResponseTypeType }
         * 
         * 
         */
        public List<Alert.Info.ResponseTypeType> getResponseType() {
            if (responseType == null) {
                responseType = new ArrayList<Alert.Info.ResponseTypeType>();
            }
         ...
         * @return
         *     possible object is
         *     {@link Alert.Info.UrgencyType }
         *     
         */
        public Alert.Info.UrgencyType getUrgency() {
            return urgency;
        }
         ...
         *     
         */
        public void setUrgency(Alert.Info.UrgencyType value) {
            this.urgency = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link Alert.Info.SeverityType }
         *     
         */
        public Alert.Info.SeverityType getSeverity() {
            return severity;
        }
         ...
         *     
         */
        public void setSeverity(Alert.Info.SeverityType value) {
            this.severity = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link Alert.Info.CertaintyType }
         *     
         */
        public Alert.Info.CertaintyType getCertainty() {
            return certainty;
        }
         ...
         *     
         */
        public void setCertainty(Alert.Info.CertaintyType value) {
        ...
        public enum CategoryType {
            ...
            public static Alert.Info.CategoryType fromValue(String v) {
                for (Alert.Info.CategoryType c: Alert.Info.CategoryType.values()) {
                    if (c.value.equals(v)) {
                        return c;
                    }
                }
        ...
        public enum CertaintyType {
            ...
            public static Alert.Info.CertaintyType fromValue(String v) {
                for (Alert.Info.CertaintyType c: Alert.Info.CertaintyType.values()) {
                    if (c.value.equals(v)) {
                        return c;
                    }
                }
        ...
        public enum ResponseTypeType {
            ...
            public static Alert.Info.ResponseTypeType fromValue(String v) {
                for (Alert.Info.ResponseTypeType c: Alert.Info.ResponseTypeType.values()) {
                    if (c.value.equals(v)) {
                        return c;
                    }
                }
        ...
        public enum SeverityType {
            ...
            public static Alert.Info.SeverityType fromValue(String v) {
                for (Alert.Info.SeverityType c: Alert.Info.SeverityType.values()) {
                    if (c.value.equals(v)) {
                        return c;
                    }
                }
        ...
        public enum UrgencyType {
            ...
            public static Alert.Info.UrgencyType fromValue(String v) {
                for (Alert.Info.UrgencyType c: Alert.Info.UrgencyType.values()) {
                    if (c.value.equals(v)) {
                        return c;
                    }
                }
    ...
    public enum MsgTypeType {
        ...
        public static Alert.MsgTypeType fromValue(String v) {
            for (Alert.MsgTypeType c: Alert.MsgTypeType.values()) {
                if (c.value.equals(v)) {
                    return c;
                }
            }
    ...
    public enum ScopeType {
        ...
        public static Alert.ScopeType fromValue(String v) {
            for (Alert.ScopeType c: Alert.ScopeType.values()) {
                if (c.value.equals(v)) {
                    return c;
                }
            }
    ...
    public enum StatusType {
        ...
        public static Alert.StatusType fromValue(String v) {
            for (Alert.StatusType c: Alert.StatusType.values()) {
                if (c.value.equals(v)) {
                    return c;
                }
            }
