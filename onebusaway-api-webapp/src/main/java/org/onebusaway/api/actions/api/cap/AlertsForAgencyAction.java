...
import org.onebusaway.api.impl.cap.AtomSupport;
...
public class AlertsForAgencyAction extends ApiActionSupport {
  ...
  @Autowired
  private AtomSupport _atomSupport;
  ...
  public void setAtomSupport(AtomSupport support) {
    _atomSupport = support;
  }
  ...
  public DefaultHttpHeaders show() throws DatatypeConfigurationException, JAXBException {
    ...
    AgencyBean ag = _service.getAgency(_agencyId);
    ...
    JAXBElement<FeedType> alertsFeed = _atomSupport.fillFeed(ag, serviceAlerts);
    ByteArrayOutputStream os = new ByteArrayOutputStream();

    JAXBContext context = JAXBContext.newInstance(Alert.class, FeedType.class);
    Marshaller m = context.createMarshaller();
    m.marshal(alertsFeed, os);
